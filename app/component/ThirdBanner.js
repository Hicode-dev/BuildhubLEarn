...
const ThirdBanner = () => {
  return (
    <div>
      <ContainLayout>
        <div className='py-10 '>
            <h1 className=' text-[36px] md:text-[40px] max-w-[572px] text-center font-[600] flex justify-center items-center mx-auto '>Powerful Collaboration technic.</h1>
            <div className='block md:hidden'>
                    <Image src='/Group 40 (3).png' width='700' height='700' alt='op' />
                </div>
            <div className='grid md:grid-cols-2 pt-4 items-center'>
                <div className='max-w-[400px]'>
                    <h1 className='text-[36px] max-w-[393px] font-[600]'>Helping you focus on what really matters</h1>
