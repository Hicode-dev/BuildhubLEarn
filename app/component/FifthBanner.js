...
const FifthBanner = () => {
  return (
    ...
    <div className='grid md:grid-cols-2   py-32 place-items-center gap-6'>
        ...
        <StackCard title='Backend Developers' Desc=' Proficient in building the server-side of web applications using programming languages such as Python, Ruby, or Java, and frameworks such as Django or Ruby MangoDb.' imageSrc='/Group 62.png' />
        ...
        <div className='gap-8 flex-col flex'>
        <StackCard title='Frontend Developers' Desc='Skilled in developing the user interface and user experience of websites and applications using HTML, CSS, and JavaScript, React/Nextjs    ' imageSrc='/Group 63 (1).png' />
